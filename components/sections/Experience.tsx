...
const TLight: Record<string, Theme> = {
  samsung: {
    ...
    borderCollapsed: "rgba(105,145,255,0.62)",
    borderOpen: "rgba(130,165,255,0.95)",
    glowOpen: "0 0 70px rgba(80,120,255,0.3), inset 0 1px 0 rgba(110,150,255,0.4)",
    dotColor: "#6090ff",
    dotGlow: "rgba(80,120,255,0.85)",
    connectorOpen: "rgba(60,100,240,0.5)",
    chipColor: "#a8c8ff",
    chipBg: "rgba(60,100,240,0.16)",
    chipBorder: "rgba(60,100,240,0.4)",
    metricColor: "#a8c8ff",
    highlightsBg: "rgba(60,100,240,0.12)",
    divider: "rgba(60,100,240,0.25)",
  },
  agentTechs: {
    cardBg: "rgba(16,30,60,0.94)",
    cardBgOpen: "rgba(16,30,60,0.97)",
    borderCollapsed: "rgba(115,185,255,0.62)",
    borderOpen: "rgba(140,200,255,0.95)",
    glowOpen: "0 0 70px rgba(90,170,255,0.3), inset 0 1px 0 rgba(120,190,255,0.4)",
    dotColor: "#70b5ff",
    dotGlow: "rgba(100,190,255,0.85)",
    connectorOpen: "rgba(80,160,255,0.5)",
    chipColor: "#b0ddff",
    chipBg: "rgba(80,160,255,0.14)",
    chipBorder: "rgba(80,160,255,0.35)",
    metricColor: "#b0ddff",
    highlightsBg: "rgba(80,160,255,0.1)",
    divider: "rgba(80,160,255,0.22)",
  },
  desknow: {
    cardBg: "rgba(16,56,52,0.94)",
    cardBgOpen: "rgba(16,56,52,0.97)",
    borderCollapsed: "rgba(75,235,215,0.58)",
    borderOpen: "rgba(100,245,225,0.95)",
    glowOpen: "0 0 70px rgba(50,220,200,0.28), inset 0 1px 0 rgba(80,235,215,0.4)",
    dotColor: "#50ffe8",
    dotGlow: "rgba(60,255,240,0.85)",
    connectorOpen: "rgba(40,200,180,0.5)",
    chipColor: "#80fff0",
    chipBg: "rgba(40,200,180,0.14)",
    chipBorder: "rgba(40,200,180,0.35)",
    metricColor: "#80fff0",
    highlightsBg: "rgba(40,200,180,0.1)",
    divider: "rgba(40,200,180,0.22)",
  },
  atthah: {
    cardBg: "rgba(52,16,56,0.94)",
    cardBgOpen: "rgba(52,16,56,0.97)",
    borderCollapsed: "rgba(240,110,230,0.58)",
    borderOpen: "rgba(250,140,245,0.95)",
    glowOpen: "0 0 70px rgba(230,80,215,0.3), inset 0 1px 0 rgba(245,120,235,0.4)",
    dotColor: "#ff80f0",
    dotGlow: "rgba(255,120,250,0.85)",
    connectorOpen: "rgba(220,70,205,0.5)",
    chipColor: "#ffc5fc",
    chipBg: "rgba(220,70,205,0.14)",
    chipBorder: "rgba(220,70,205,0.35)",
    metricColor: "#ffc5fc",
    highlightsBg: "rgba(220,70,205,0.1)",
    divider: "rgba(220,70,205,0.22)",
  },
  ncsm: {
    cardBg: "rgba(34,20,66,0.94)",
    cardBgOpen: "rgba(34,20,66,0.97)",
    borderCollapsed: "rgba(180,145,255,0.62)",
    borderOpen: "rgba(200,165,255,0.95)",
    glowOpen: "0 0 70px rgba(160,120,255,0.3), inset 0 1px 0 rgba(185,150,255,0.4)",
    dotColor: "#cbb5ff",
    dotGlow: "rgba(185,150,255,0.85)",
    connectorOpen: "rgba(150,105,250,0.5)",
    chipColor: "#eddcff",
    chipBg: "rgba(150,105,250,0.14)",
    chipBorder: "rgba(150,105,250,0.35)",
    metricColor: "#eddcff",
    highlightsBg: "rgba(150,105,250,0.1)",
    divider: "rgba(150,105,250,0.22)",
  },
};
