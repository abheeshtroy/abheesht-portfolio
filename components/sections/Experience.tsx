...
const TLight: Record<string, Theme> = {
  samsung: {
    ...
    borderCollapsed: "rgba(80,120,255,0.65)",
    borderOpen: "rgba(100,140,255,1)",
    glowOpen: "0 0 80px rgba(80,120,255,0.45), inset 0 1px 0 rgba(100,140,255,0.60)",
    dotColor: "#6090ff",
  ...
  agentTechs: {
    ...
    borderCollapsed: "rgba(100,190,255,0.65)",
    borderOpen: "rgba(120,210,255,1)",
    glowOpen: "0 0 80px rgba(100,190,255,0.40), inset 0 1px 0 rgba(120,210,255,0.55)",
    dotColor: "#70b5ff",
    dotGlow: "rgba(100,190,255,0.90)",
  ...
  desknow: {
    ...
    borderCollapsed: "rgba(70,255,240,0.60)",
    borderOpen: "rgba(80,255,245,1)",
    glowOpen: "0 0 80px rgba(60,255,240,0.35), inset 0 1px 0 rgba(80,255,245,0.55)",
    dotColor: "#50ffe8",
    dotGlow: "rgba(60,255,240,0.90)",
  ...
  atthah: {
    ...
    borderCollapsed: "rgba(255,120,250,0.60)",
    borderOpen: "rgba(255,150,255,1)",
    glowOpen: "0 0 80px rgba(255,120,250,0.40), inset 0 1px 0 rgba(255,150,255,0.55)",
    dotColor: "#ff80f0",
    dotGlow: "rgba(255,120,250,0.90)",
  ...
  ncsm: {
    ...
    borderCollapsed: "rgba(185,150,255,0.65)",
    borderOpen: "rgba(200,170,255,1)",
    glowOpen: "0 0 80px rgba(185,150,255,0.40), inset 0 1px 0 rgba(200,170,255,0.55)",
    dotColor: "#cbb5ff",
    dotGlow: "rgba(185,150,255,0.90)",
